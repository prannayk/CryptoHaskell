...
x2 str1 str2 = [xor (str1!!0) (str2 !! 0)] ++ [xor (str2 !! 1) (str1 !! 1)]++[xor (str1 !! 2) (str2 !! 2)]++ [xor (str1!!3) (str2 !! 3)] ++ [xor (str2 !! 4) (str1 !! 4)]++[xor (str1 !! 5) (str2 !! 5)]++ [xor (str1!! 6) (str2 !! 6)] ++ [xor (str2 !! 7) (str1 !! 7)]++[xor (str1 !! 8) (str2 !! 8)]++ [xor (str1!!9) (str2 !! 9)] ++ [xor (str2 !! 10) (str1 !! 10)]++[xor (str1 !! 12) (str2 !! 12)]++ [xor (str1!!13) (str2 !! 13)] ++ [xor (str2 !! 11) (str1 !! 11)]++[xor (str1 !! 14) (str2 !! 14)]++ [xor (str1!!15) (str2 !! 15)] ++[xor (str2 !! 16) (str1 !! 16)]++[xor (str1 !! 17) (str2 !! 17)]++ [xor (str1!!18) (str2 !! 18)] ++ [xor (str2 !! 19) (str1 !! 19)]++[xor (str1 !! 20) (str2 !! 20)]++ [xor (str1!!21) (str2 !! 21)] ++ [xor (str2 !! 22) (str1 !! 22)]++[xor (str1 !! 23) (str2 !! 23)]++ [xor (str1 !! 24) (str2 !! 24)]++[xor (str2 !! 25) (str1 !! 25 )]++[xor (str1!!26) (str2 !! 26)] ++ [xor (str2 !! 27) (str1 !! 27)]++[xor (str1 !! 28) (str2 !! 28)]++ [xor (str1!!29) (str2 !! 29)] ++ [xor (str2 !! 30) (str1 !! 30)]++[xor (str2 !! 31) (str1 !! 31)]
-- x0r fin
-- right part function 
right :: String-> String
right b = reverse (take 32 (reverse b))
-- hexabinarystring part
...
binarystring [] = []
binarystring (x:xs) = convert_binary1 x ++ binarystring xs
convert_binary1 :: Char -> String
convert_binary1 a 
 | a == '0'= "0000"
 | a == '1' = "0001"
 | a =='2'= "0010"
...
decryption abc key4 = binarytohexa8 (subkeyfinal (calcb 16 b16 key2))  
 where key2 = binarystring key4
       b16 = subkey5 (binarystring abc)
calcb :: Int-> String -> String -> String
calcb 0 xs key2 = xs
calcb n xs key2 = calcb (n-1) ((x2 (right xs) (function (take 32 xs) (key key2 n))) ++ take 32 (xs)) key2 
...
-- initial permutation finishes and final permutaion starts
...
bit1 :: String->String
bit1 key = [get key 1] ++ [get key 2] ++ [get key 3] ++ [get key 4]++[get key 5] ++ [get key 6] ++ [get key 7] ++ [get key 8]++[get key 9] ++ [get key 10] ++ [get key 11] ++ [get key 12]++[get key 13] ++ [get key 14] ++ [get key 15] ++ [get key 16] ++ [get key 17] ++ [get key 18] ++ [get key 19]++[get key 20] ++ [get key 21] ++ [get key 22] ++ [get key 23]++[get key 24] ++ [get key 25] ++ [get key 26] ++ [get key 27]++[get key 28] ++ [get key 29] ++ [get key 30] ++[get key 31]++[get key 32]++[get key 33]++[get key 34] ++ [get key 35] ++ [get key 36] ++ [get key 37]++[get key 38] ++ [get key 39] ++ [get key 40] ++ [get key 41] ++ [get key 42] ++ [get key 43] ++ [get key 44]++[get key 45] ++[get key 46] ++ [get key 47] ++ [get key 48]
-- function part finishes 
-- key part starts
--convert 64 bit key into 56 bit key
